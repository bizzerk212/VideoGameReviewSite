...
require_once(dirname(__FILE__).'./Classes/CCritic.php');



if(count($_POST) >= 1) {
         $new_critic= new CCRitic($_POST['txtid'], $_POST['txtname'],
